...
def init_bpf(in_ms, in_pids, in_tids, in_pid, in_pidnss):
	# define BPF program
	bpf_text = """
...
def runqlatnewUtil(in_ms, in_pids, in_tids, in_pid, in_pidnss, in_interval, in_count):
	countdown = abs(int(in_count))
	old_stdout = sys.stdout
	sys.stdout = output = StringIO()
	b = init_bpf(in_ms, in_pids, in_tids, in_pid, in_pidnss)
